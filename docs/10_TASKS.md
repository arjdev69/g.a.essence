...
- [ ] T-077 — Garantir exportação ICS local no navegador com contrato de evento consistente · Arquivos: src/domain/calendar, src/services/export/downloadFile.ts, src/features/appointments/AppointmentsPage.tsx · Atende: sprint 16/17, TASK-1, TASK-2, TASK-3 · Depende de: T-076 · verify: atendimento salvo gera download local `.ics`, título/descrição/duração/fuso e nome do arquivo seguem o contrato, sem upload remoto nem alteração do atendimento
