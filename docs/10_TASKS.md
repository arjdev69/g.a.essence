...
- [x] T-073 — Testar estados, acessibilidade e desempenho do relatório filtrado · Arquivos: src/tests/report.test.ts, src/tests/reportPage.test.tsx, src/features/reports/ReportsPage.tsx, package.json, package-lock.json · Atende: RF-024, RF-027, CA-017, CA-018, CA-019, CA-020, CA-021, CA-028, RNF-009, RNF-010 · Depende de: T-071, T-072 · verify: 11 arquivos e 63 testes passam, axe não aponta violação crítica ou séria e 1.000 registros filtram em até 500ms; loading, vazio, erro recuperável, sucesso e labels semânticos estão cobertos

## Bloco 18 — Formulário, telas complementares e validação integrada

- [x] T-074 — Refinar formulário mobile, cálculo ao vivo e proteção contra envio duplicado · Arquivos: src/features/appointments/AppointmentForm.tsx, src/features/appointments/AppointmentsPage.tsx, src/tests/appointmentForm.test.tsx · Atende: RF-025, CA-022, CA-023, CA-024, CA-025, RNF-008, RNF-009 · Depende de: T-067 · verify: 2 testes passam; ordem paciente/serviço/profissional, autopreenchimento, cálculo, fonte mobile de 16 px, alvos de toque de 44 px e mutation única estão cobertos
- [x] T-075 — Aplicar o sistema mobile a login, dashboard, pacientes, profissionais e serviços · Arquivos: src/features/auth/LoginPage.tsx, src/features/dashboard/DashboardPage.tsx, src/features/patients/PatientsPage.tsx, src/features/professionals/ProfessionalsPage.tsx, src/features/services/ServicesPage.tsx, src/app/AppRoutes.tsx, src/tests/mobileScreens.test.tsx · Atende: RF-026, CA-026, CA-027, RNF-008, RNF-009 · Depende de: T-067 · verify: 5 testes DOM responsivos passam; login, filtros e ações usam alvos de toque de 44 px e fonte de entrada de 16 px no mobile, cadastros usam cards sem tabela horizontal, dashboard usa resumo em duas colunas e não introduz overflow horizontal; lint e build passam
- [x] T-076 — Validar fluxos completos, matriz de estados, acessibilidade e regressão desktop · Arquivos: src/tests/mobileUxFlow.test.tsx, src/tests, src/index.css, src/features/dashboard/DashboardPage.tsx, src/features/appointments/AppointmentsPage.tsx, src/features/patients/PatientsPage.tsx, src/features/professionals/ProfessionalsPage.tsx, src/features/services/ServicesPage.tsx, src/features/patients/PatientForm.tsx, src/features/professionals/ProfessionalForm.tsx, src/features/services/ServiceForm.tsx, src/features/reports/ReportsPage.tsx, src/components/ui/Modal.tsx, src/components/layout/AppLayout.tsx, src/features/pwa/AppointmentNotificationsButton.tsx, src/features/pwa/InstallPwaButton.tsx · Atende: RF-027, CA-028, RNF-008, RNF-009, RNF-010 · Depende de: T-070, T-073, T-074, T-075 · verify: matriz integrada cobre loading, vazio, erro recuperável, sucesso, axe sem violação crítica/séria nas telas principais, troca cards/tabela preservada no desktop/mobile, 14 arquivos e 75 testes passam, npm run lint e npm run build passam; overflow horizontal global é bloqueado

## Bloco 19 — Exportação de atendimentos para calendário

- [x] T-077 — Garantir exportação ICS local no navegador com contrato de evento consistente · Arquivos: src/domain/calendar, src/features/appointments/AppointmentsPage.tsx, src/tests/appointmentFilters.test.tsx, src/tests/calendar.test.ts, src/tests/downloadFile.test.ts · Atende: sprint 16/17, TASK-1, TASK-2, TASK-3 · Depende de: T-076 · verify: 12 testes direcionados passam; atendimento salvo gera download local `.ics`, título/descrição/duração/fuso e nome do arquivo seguem o contrato, sem upload remoto nem alteração do atendimento
- [x] T-078 — Refinar ação desktop/mobile e feedback de calendário · Arquivos: src/features/appointments/AppointmentsPage.tsx, src/tests/appointmentFilters.test.tsx · Atende: sprint 16/17, TASK-4, TASK-5 · Depende de: T-077 · verify: 6 testes passam; ação secundária permanece acessível na tabela e no card, alvo mobile tem 44 px, estados normal/foco/loading/sucesso/erro são anunciados e dados incompletos bloqueiam a ação com orientação
- [x] T-079 — Validar contrato, fluxo, acessibilidade e consistência visual do calendário · Arquivos: src/tests/calendar.test.ts, src/tests/downloadFile.test.ts, src/tests/appointmentFilters.test.tsx, docs/16_CALENDAR_SPRINT.md, docs/17_CALENDAR_IMPLEMENTATION.md, docs/08_TEST_SPEC.md · Atende: sprint 16/17, TASK-6, TASK-7 · Depende de: T-077, T-078 · verify: 14 arquivos e 78 testes passam; testes unitários e de interface cobrem desktop/mobile, escape ICS, duração, arquivo, loading, sucesso/erro, axe sem violação crítica/séria e checklist da sprint foi reconciliado
