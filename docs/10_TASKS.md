...
- [ ] T-078 — Refinar ação desktop/mobile e feedback de calendário · Arquivos: src/features/appointments/AppointmentsPage.tsx, src/tests/appointmentFilters.test.tsx · Atende: sprint 16/17, TASK-4, TASK-5 · Depende de: T-077 · verify: ação secundária permanece acessível na tabela e no card, alvo mobile tem 44 px, estados normal/foco/loading/sucesso/erro são anunciados e dados incompletos bloqueiam a ação com orientação
