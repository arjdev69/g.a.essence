...
- [ ] T-079 — Validar contrato, fluxo, acessibilidade e consistência visual do calendário · Arquivos: src/tests/calendar.test.ts, src/tests/downloadFile.test.ts, src/tests/appointmentFilters.test.tsx, docs/16_CALENDAR_SPRINT.md, docs/17_CALENDAR_IMPLEMENTATION.md, docs/08_TEST_SPEC.md · Atende: sprint 16/17, TASK-6, TASK-7 · Depende de: T-077, T-078 · verify: testes unitários e de interface cobrem desktop/mobile, escape ICS, duração, arquivo, loading, sucesso/erro, axe sem violação crítica/séria e checklist da sprint é reconciliado
